...
namespace HouseRentingSystem.Data.Migrations
{
    ...
    [Migration("20240301170843_AddCustomAdminAgent")]
    partial class AddCustomAdminAgent
    {
            ...
            modelBuilder.Entity("HouseRentingSystem.Data.Models.Agent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ace3ab43-264e-4b2d-b56d-274170bacfc5"),
                            PhoneNumber = "+359888888888",
                            UserId = new Guid("2fe36acb-8c75-42d4-c03d-08dc1ff94547")
                        },
                        new
                        {
                            Id = new Guid("6a347f29-0054-40ec-9f7a-1099d214430e"),
                            PhoneNumber = "+359888888887",
                            UserId = new Guid("50c9caf6-b29d-40bb-805b-60b2239c658d")
                        });
                });
            ...
            modelBuilder.Entity("HouseRentingSystem.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2fe36acb-8c75-42d4-c03d-08dc1ff94547"),
                            AccessFailedCount = 0,
                        ...
                        new
                        {
                            Id = new Guid("6acc5766-87f9-4f30-c03e-08dc1ff94547"),
                            AccessFailedCount = 0,
                        ...
                        new
                        {
                            Id = new Guid("50c9caf6-b29d-40bb-805b-60b2239c658d"),
                            AccessFailedCount = 0,
            ...
            modelBuilder.Entity("HouseRentingSystem.Data.Models.House", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b822afa5-6866-46cd-8f7d-e3863bd83068"),
                            Address = "North London, UK (near the border)",
                            AgentId = new Guid("ace3ab43-264e-4b2d-b56d-274170bacfc5"),
                            CategoryId = 3,
                            CreatedOn = new DateTime(2024, 3, 1, 17, 8, 42, 871, DateTimeKind.Utc).AddTicks(9685),
                            ...
                            RenterId = new Guid("6acc5766-87f9-4f30-c03e-08dc1ff94547"),
                            Title = "Big House Marina"
                        },
                        new
                        {
                            Id = new Guid("6472b798-66f0-4128-a72b-955b81cc5b71"),
                            Address = "Near the Sea Garden in Burgas, Bulgaria",
                            AgentId = new Guid("ace3ab43-264e-4b2d-b56d-274170bacfc5"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2024, 3, 1, 17, 8, 42, 871, DateTimeKind.Utc).AddTicks(9715),
                        ...
                        new
                        {
                            Id = new Guid("05794355-999c-443c-a55d-aa0c08a0c5ba"),
                            Address = "Boyana Neighbourhood, Sofia, Bulgaria",
                            AgentId = new Guid("ace3ab43-264e-4b2d-b56d-274170bacfc5"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2024, 3, 1, 17, 8, 42, 871, DateTimeKind.Utc).AddTicks(9720),
